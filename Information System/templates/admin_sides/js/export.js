...
[
    ['exportAccountingBtn', '/api/accounting', 'transaction_date', 'Accounting', 'accounting', [['CV No.', 'cv_no'], ['Date', 'transaction_date'], ['Payee', 'payee'], ['Transaction Details', 'transaction_details'], ['Suppliers Name', 'supplier_name'], ['TIN', 'tin'], ['Address', 'address'], ['Amount', 'amount'], ['VAT 12%', 'vat_12'], ['Net of VAT', 'net_of_vat'], ['VAT Exemot', 'vat_exempt'], ['Non-vat', 'non_vat'], ['WTax', 'wtax'], ['SI No.', 'si_no'], ['SI Date', 'si_date'], ['Acct. Code', 'account_code'], ['Acct. Name', 'account_name'], ['Project', 'project'], ['Remark', 'remark']]],
    ['exportSalesBtn', '/api/sales', 'transaction_date', 'Sales', 'sales', [['Month', 'month'], ['Client Name', 'client_name'], ['Proj Code', 'project_code'], ['TIN', 'tin'], ['Address', 'address'], ['Po Amount', 'po_amount'], ['SI No.', 'si_no'], ['SI Date', 'si_date'], ['Inv Amount', 'inv_amount'], ['VAT', 'vat'], ['Net of VAT', 'net_of_vat'], ['2% WTax', 'wtax_2'], ['Net Amount', 'net_amount'], ['Cash in Bank', 'cash_in_bank'], ['Date', 'transaction_date'], ['Bank', 'bank'], ['Remarks', 'remarks'], ['PO No.', 'po_no'], ['Description', 'description']]],
    ['exportMarketingBtn', '/api/sales_marketing', 'date_received', 'Marketing', 'marketing', [['Date Received', 'date_received'], ["Client's Name/Company", 'client_name'], ['Projects Name', 'project_name'], ['Source', 'source'], ['Project Value', 'project_value'], ['Project Type', 'project_type'], ['Deadline of Submission', 'deadline_submission'], ['Days of Deadlines', 'days_deadline'], ['Status', 'status'], ['Date Submitted', 'date_submitted'], ['Response Time(Days)', 'response_time'], ['Follow-up Date', 'follow_up_date'], ['Days to Follow-up', 'days_follow_up'], ['File', 'file_name'], ['Lost Reason', 'lost_reason']]],
    ['exportPurchasingBtn', '/api/purchasing', 'purchase_date', 'Purchasing', 'purchasing', [['Purchase Order No.', 'po_no'], ['Date', 'purchase_date'], ['Supplier Name', 'supplier_name'], ['TIN', 'tin'], ['Address', 'address'], ['Item Code', 'item_code'], ['Item Name', 'item_name'], ['Description', 'description'], ['Quantity', 'quantity'], ['Unit', 'unit'], ['Unit Price', 'unit_price'], ['Discount', 'discount'], ['VAT', 'vat'], ['Total Amount', 'total_amount'], ['Requested By', 'requested_by'], ['Approved By', 'approved_by'], ['Date Approved', 'date_approved'], ['Documents', 'documents'], ['Remarks', 'remarks']]],
    ['exportEngineeringBtn', '/api/engineering', 'date', 'Engineering', 'engineering', [['Project Name', 'project_name'], ['Project Location', 'location'], ['Client', 'client'], ['Date', 'date'], ['Status', 'status'], ['Materials Needed', 'materials_needed'], ['Accomplishment Percentage', 'accomplishment_percentage'], ['Target Completion', 'target_completion'], ['Manpower', 'manpower'], ['Document', 'file_name'], ['Remarks', 'lost_reason']]]
