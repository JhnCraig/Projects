(() => {
    ...
    document.querySelectorAll('.dropdown-menu[id$="FilterMenu"]').forEach((menu) => {
        ...
        search.type = 'search';
        search.className = 'form-control form-control-sm table-filter-search';
        search.placeholder = 'Search table';
        search.setAttribute('aria-label', 'Search table');
        dropdown.parentElement?.insertBefore(search, dropdown);
        ...
        search.addEventListener('input', () => filterTable(menu, search.value));
    });
})();
